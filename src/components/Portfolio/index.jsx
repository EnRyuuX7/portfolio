...
const items = [
  ...
  },
  {
    ...
    image: "/discord-c.jpg",
    description:
      "An attempt to clone the functionalities of discord using react, socket.io, node, mongodb and jwt authentication.",
  ...
  },
  {
    ...
    image: "/cursor.png",
    description:
      "This is a cursor port from linux to windows using photoshop, real world cursor editor and Inkscape. ",
  ...
  },
  {
    ...
    image: "/covidx.png",
    description:
      "A pandemic resource management system, that displays covid data throughout Nepal. I contributed on this project by handling all frontend UI/UX design and development",
  ...
  },
  {
    ...
    image: "/shapeup.png",
    description:
      "2D platformer game where user controls a square character and has to survive in the dynamic environment for as long as possible while being chased around by an enemy triangle.",
  ...
  },
  {
    ...
    image: "/notes.png",
    description:
      "This is a rainmeter .rmskin that was designed for Rainmeter. As it's name suggests, it is a transparent note for your Desktop",
  ...
  return (
    <div className={`one-half column ${styles.folio__item}`}>
      ...
      <Popup
        trigger={
          <div
            className={`${styles.overlay} ${toggle && styles.toggle__overlay}`}
          >
            <div className={styles.folio__itemTable}>
              <div
                id={styles.itemCell}
                className={`${styles.folio__itemCell} ${
                  toggle && styles.toggleCell
                }`}
              >
          ...
          <div className={styles.popup__modal}>
            ...
            <div className={styles.popup__descriptionBox}>
              ...
              <div className={styles.popup__categories}>
                ...
                {categories.map((item) => {
                  return (
                    <span className={styles.popup__categoryChip}>{item}</span>
                  );
                })}{" "}
              </div>
            </div>

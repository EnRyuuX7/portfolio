...
const items = [
    {
        ...
        image: "/design.jpg",
        description:
            "An interactive web-app made using HTML, CSS, JS (jQuery, p5.js, VanillaJS) where the user can create and learn about generative art. <br />This website features a sketch named Weave.js made from scratch using 3 different concepts (Kaleidoscope, perlin noise and bezier curves) which generates unique and random symmetrical generative art with a huge range of customization option",
                    ...
                    <div className={styles.popup__modal}>
                        ...
                        <div className={styles.popup__descriptionBox}>
                            ...
                            <div className={styles.popup__categories}>
                                {" "}
                                {categories.map((item) => {
                                    return <span className={styles.popup__categoryChip}>{item}</span>;
                                })}{" "}
                            </div>
                        </div>

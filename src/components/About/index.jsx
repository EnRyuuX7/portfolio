                ...
                <div className={styles.about__info}>
                    <div className='row aligned'>
                        ...
                        <div className='two-thirds column'>
                            <p className={styles.lead}>Born in Kathmandu Nepal, I am a ReactJS developer as well as a UI/UX designer with a passion for designing and developing different web-based applications.
